return PlaceObj('ModDef', {
	...
	'last_changes', "3.14\nFixed issue with nil variable causing mod to not work in a very rare cases\nBetter grenade distribution: now grenades are automatically splitted into 5 categories (Traps/Smokes/HEs/Flares/Other): no more Traps spam late in the game\nImproved TacicalAI-specific logic",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
