return PlaceObj('ModDef', {
	...
	'last_changes', "Version 3.3\nBrought back the Add Weapon Components mod option\nAdjusted number and strength of weapon components - dropped weapons will now have fewer and less powerful components. Getting chips early should be much less common.\nAdjusted weapons and armor progression curve - worst weapons are now more likely to be used by enemies. Finding better weapons will now be more rewarding.",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
