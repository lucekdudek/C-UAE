return PlaceObj('ModDef', {
	...
	'last_changes', "Version 3.11\nImproved weapons' attachments rarity progression. Now components which require rare ingredients will be limited to high level enemies.\nReduced number of attachments on low level enemies and adjusted progression curve accordingly.",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
