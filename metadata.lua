return PlaceObj('ModDef', {
	...
	'last_changes', "Version 3.10\nAdded support for subweapons(Underslung Launcher) ammunition - enemies will no longer be limited to a single type of 40mm grenades",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
