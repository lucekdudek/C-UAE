return PlaceObj('ModDef', {
	...
	'last_changes', "Version 3.6\nAllow AlternativeWeaponTypeTables to work when ReplaceWeapons is disabled(TAIP without main C-UAE replacement feature)",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
