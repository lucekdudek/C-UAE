return PlaceObj('ModDef', {
	...
	'last_changes', "Greatly improve weapon attachments logic now better attachments are more likelly to appear for higher level enemies",
	'ignore_files', {
		"*.git/*",
		"*.svn/*",
		"*.code-workspace/*",
